 ...
 */
final class Version20230916144604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        # $this up() migration is auto-generated, please modify it to your needs
         ...
         $this->addSql('ALTER TABLE user ADD niveau VARCHAR(255) DEFAULT NULL, ADD progres INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP niveau, DROP progres');
    }
}
